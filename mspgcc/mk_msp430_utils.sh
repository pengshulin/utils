...
# Ubuntu 12 and MAC OS 10.6. We were using the laste available  #
# compiler for building the new compiler:                       #
# msp430-gcc (GCC) 4.6.3 20120301 (mspgcc LTS20120406 unpatched)#
